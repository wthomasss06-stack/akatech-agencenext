 ...
 * (tunnel-modal / elvis-portfolio) : image fixe à gauche, détails
 * scrollables à droite. Contenu 100% issu de lib/data.js
 * (PROJECTS), sans inventer de champs qui n'existent pas côté
 * données.
 */
