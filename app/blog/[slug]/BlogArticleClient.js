        ...
        <div style={{ maxWidth: 780, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .6 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '.8rem', marginBottom: '1.2rem', flexWrap: 'wrap' }}>
              <span style={{ padding: '.25rem .85rem', borderRadius: 100, background: T.light ? 'rgba(22,163,74,.08)' : 'rgba(34,200,100,.08)', border: `1px solid ${T.border}`, fontFamily: "'JetBrains Mono',monospace", fontSize: '.62rem', color: T.green, display: 'flex', alignItems: 'center', gap: '.35rem' }}>
        ...
        <div style={{ maxWidth: 780, margin: '0 auto' }}>
          ...
          <motion.div
            ...
            <div>
              ...
              <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: '.62rem', color: T.greenSub, letterSpacing: '.06em' }}>Fondateur · AKATech · Développeur Full-Stack</div>
            </div>
              ...
              {related.map((p, i) => (
                <motion.article key={p.slug} className="sku-card"
                  ...
                  <div style={{ padding: '1.3rem' }}>
                    <span style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: '.6rem', color: T.green, letterSpacing: '.06em', display: 'flex', alignItems: 'center', gap: '.3rem', marginBottom: '.7rem' }}>
