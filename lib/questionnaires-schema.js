...
export const QUESTIONNAIRES = {
  ...
  vitrine_ecommerce: {
    ...
    intro: "Afin de bien comprendre votre activité et de vous proposer une offre adaptée, merci de répondre directement à chaque question. Si une question ne vous concerne pas, indiquez « Non concerné ».",
    sections: [
      {
      ...
      },
      {
        ...
        fields: [
          ...
          { id: "has_photos", label: "Avez-vous des photos de l'établissement, produits/plats, équipe ou événements ?", type: "radio", options: ["Oui", "Non, à prévoir"] },
      ...
      },
      {
        title: "Paiement",
        fields: [
          { id: "online_payment", label: "Paiement en ligne souhaité ?", type: "checkboxes",
            options: ["Non souhaité", "Orange Money", "MTN MoMo", "Wave", "Carte bancaire", "Autre"] },
  ...
  saas: {
    ...
    intro: "Une application web ou un SaaS demande une compréhension précise du fonctionnement souhaité. Ce questionnaire sert de première base de diagnostic avant de définir le périmètre et le devis.",
    sections: [
      {
        title: "Le projet",
        fields: [
